  ...
  return (
    <>
      <div className='w-full'>
        <div className='bg-zinc-100 h-[400px] w-full my-6 max-sm:h-[500px] max-sm:my-1 max-sm:w-[390px]'>
          ...
          <img className='h-[300px] opacity-80 rounded-lg mt-10 absolute left-[62%] object-cover max-sm:invisible' src="https://images.unsplash.com/photo-1532635211-8ec15f2ce05c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8Y29va3xlbnwwfHwwfHx8MA%3D%3D" alt="" />
        </div>
        <div className='text-center'>
          <h1 className='text-red-600 tracking-[7px] uppercase mt-10 max-sm:mt-10'>{data}</h1>
          <h1 className='text-4xl font-bold max-sm:text-lg my-3'>Get a many of interesting <br />features</h1>
        </div>
      </div>
    </>
  )
